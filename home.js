    ...
    if(document.querySelector("#nu")==null){
        document.querySelector("#nu")="hi"
    }

    let a1=JSON.parse(localStorage.getItem("loginpersonname"))
let b1=JSON.parse(localStorage.getItem("userdata"))
document.querySelector("h4").append(a1)
let c=0
let det=()=>{
 c++
b1.map(function(el){
